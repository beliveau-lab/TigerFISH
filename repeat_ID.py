...
chr_name_jf_out="repeat_id_out/"+chrom+"_jf_temp.txt"
out_index="repeat_id_out/"+chrom+"_index.txt"
bed_file="repeat_id_out/"+chrom + "_regions.bed"
out_fasta="repeat_id_out/"+chrom + "_regions.fa"
...
def generate_index_file(normal_ranges_df):
    ...
    #kmer_indices=[x for start,end in zip(start_ranges_list,end_ranges_list) for x in range(start,end+1)]
...
def generate_fasta(scaffold_fasta):
    """
